...
# Process list of foreign names and their variations
    ...
    df_local_teams = df[(df['TEAM']!='Malaysia')&(df['TEAM']!='THAILAND')&(df['TEAM']!='China') 
                           ...
                           &(df['NATIONALITY']!=('GBR'|'IND'|'JPN'|'MAS'|'INA'))] 
    ...
    final_df = final_df.reindex(columns= ['NAME', 'RANK', 'TEAM', 'RESULT', 'RESULT_CONV', 'WIND', 'EVENT_x', 'CATEGORY_EVENT', 'DIVISION', 'STAGE', 'AGE',  'DOB', 'GENDER', 'UNIQUE_ID', 'NATIONALITY', 'DICT_RESULTS', 'YEAR', 'event_date_dt', 'COMPETITION',
