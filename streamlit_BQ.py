...
# Process list of foreign names and their variations
    ...
    final_df = final_df.reindex(columns= ['NAME', 'RANK', 'TEAM', 'RESULT', 'RESULT_CONV', 'WIND', 'EVENT_x', 'DIVISION', 'STAGE', 'AGE', 'GENDER', 'UNIQUE_ID', 'NATIONALITY', 'DICT_RESULTS', 'YEAR', , 'event_date_dt', 'COMPETITION', 'DOB', 'CATEGORY_EVENT',
